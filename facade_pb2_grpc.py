...
if _version_not_supported:
    raise RuntimeError(
        ...
        + f' but the generated code in facade_pb2_grpc.py depends on'
...
class FacadeServiceStub(object):
...
class FacadeServiceServicer(object):
    """Missing associated documentation comment in .proto file."""
...
def add_FacadeServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'facade.FacadeService', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('facade.FacadeService', rpc_method_handlers)
